...
impl Plugin for LdtkPlugin {
    fn build(&self, mut app: &mut App) {
        ...
        app.add_plugins(assets::LdtkAssetPlugin)
            .configure_sets(ProcessLdtkApi, (ProcessApiSet::PreClean, ProcessApiSet::Clean).chain())
            ...
            .add_systems(PreUpdate, (systems::process_ldtk_assets, systems::process_ldtk_levels))
            .add_systems(
                ProcessLdtkApi,
